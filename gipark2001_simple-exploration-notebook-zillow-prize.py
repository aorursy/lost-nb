...
train_df['Date'] = pd.to_datetime(train_df['transactiondate'], errors='coerce')
...
train_df['transaction_month'] = train_df['Date'].dt.month
...
sns.jointplot(x=prop_df.latitude.values, y=prop_df.longitude.values, height=10)
