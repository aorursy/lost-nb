...
def prepare_data(df_data, train=True):
    ...
    df_data['brand_cat']  = 'cat1_'+df_data['category1'].astype(str)+' '+    'cat2_'+df_data['category2'].astype(str)+' '+    'cat3_'+df_data['category3'].astype(str)+' '+    'brand_'+df_data['brand_name'].astype(str) 
    
    df_data['name']  = df_data['brand_cat']  + ' ' + df_data['name']
    
    df_data['name_desc']  = df_data['name'] + ' ' +    df_data['item_description'].apply(lambda x : ' '.join( x.split()[:5]))
