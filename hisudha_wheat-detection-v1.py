...
WEIGHTS = '../input/best-yolov5x-fold0-1pt/best_yolov5x_fold0.pt'
...
if PSEUDO:
    ...
    if is_TEST:
        get_ipython().system('python train.py --weights {WEIGHTS} --img 1024 --batch 4 --epochs {EPO} --data {DATA} --cfg {CONFIG}')
    else:
        get_ipython().system('python train.py --weights {WEIGHTS} --img 1024 --batch 4 --epochs 1 --data {DATA} --cfg {CONFIG}')
