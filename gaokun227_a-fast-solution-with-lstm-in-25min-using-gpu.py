...
hist = model.fit(train_x, train_y,                  validation_data=(val_x, val_y),                  epochs=nb_epoches, batch_size=2048, shuffle=True, verbose=2,                  callbacks=[early_stopping, model_checkpoint])
