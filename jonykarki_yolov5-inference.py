...
def makePseudolabel():
    ...
    weights = '../input/yolov5model/best_yolov5x_fold0.pt'
    imgsz = 1024
    conf_thres = 0.5
    iou_thres = 0.6
    is_TTA = True
...
if len(os.listdir('../input/global-wheat-detection/test/'))<11:
    ...
    get_ipython().system('python train.py --img 1024 --batch 4 --epochs 10 --data ../input/configyolo5/wheat0.yaml --cfg ../input/configyolo5/yolov5x.yaml --weights ../input/yolov5model/best_yolov5x_fold0.pt')
