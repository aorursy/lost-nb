...
# !cat ../input/yolov5-files/yolov5_weights/yolov5_models/training_results/results_yolov5x.txt
...
def makePseudolabel():
    ...
    weights = '../input/yolov5/yolov5-master/weights/best_yolov5x_fold0.pt'
    imgsz = 1024
    conf_thres = 0.5
    iou_thres = 0.6
    is_TTA = True
