...
for fold_id, (tr_idx, vl_idx) in enumerate(FOLD_LIST):
    ...
    model.fit(x_tr, y_tr, epochs=2, batch_size=1024, validation_data=[x_vl, y_vl], callbacks=[es])
...
for fold_id, (tr_idx, vl_idx) in enumerate(FOLD_LIST):
    ...
    model.fit(x_tr, y_tr, callbacks=[metric], epochs=12, batch_size=1024, validation_data=[x_vl, y_vl])
