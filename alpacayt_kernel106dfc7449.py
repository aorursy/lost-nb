...
sys.path.append("../input/yolov5baseline/yolov5-master-update")
...
def makePseudolabel():
    ...
    weights = '../input/yolov5baseline/yolov5-master-update/weights/best.pt'
    imgsz = 1024
    conf_thres = 0.5
    iou_thres = 0.6
    is_TTA = True
...
if len(os.listdir('../input/global-wheat-detection/test/'))<11:
    ...
    get_ipython().system('python ../input/yolov5baseline/yolov5-master-update/train.py --img 1024 --batch 4 --epochs 10 --data ../input/yolov5baseline/yolov5-master-update/gwdconfig/wheat0.yaml --cfg ../input/yolov5baseline/yolov5-master-update/gwdconfig/yolo5_PANET.yaml --weights ../input/yolov5baseline/yolov5-master-update/weights/best.pt')
