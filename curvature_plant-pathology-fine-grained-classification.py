...
ensemble_1.loc[:, 'healthy':] = 0.50*probs_dnn + 0.50*probs_efnns
ensemble_2.loc[:, 'healthy':] = 0.25*probs_dnn + 0.75*probs_efnns
ensemble_3.loc[:, 'healthy':] = 0.75*probs_dnn + 0.25*probs_efnns
